            ...
            <?php echo form_open(); ?>
                <div class="form-group">
                    ...
                    <div class="mt-3">
                        ...
                        <input class="form-control mt-2" type="text" name="pro_photo" value="<?php echo set_value('pro_photo'); ?>" placeholder="L'ajout de photo ne sera possible qu'après création de la fiche produit" disabled>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <option value="" <?php if(isset($_POST['pro_cat_id']) && $_POST['pro_cat_id'] == ""){echo"selected";} ?>>Choisir</option>
                        <?php
                    ...
                    <div class="mt-3">                            
                        ...
                        <div class="form-check form-check-inline"> 
                        <input class="form-check-input" type="radio" name="pro_bloque" id="no" value="NULL" <?php if(!isset($pro_bloque) || ($pro_bloque == NULL)){echo "checked=checked";}?>>Non
                        </div>
                    </div>
