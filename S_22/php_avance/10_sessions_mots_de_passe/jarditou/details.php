        ...
        <div class="col-md-8 ">
            <form action="" method="post">
                <div class="form-group ">
                    ...
                    <a class="btn btn-secondary btn-lg px-3 me-3 mt-4" href="tableau.php" role="button" >Retour</a>
                    <a class="btn btn-secondary btn-lg px-3 me-3 mt-4" href="#" role="button" >Ajouter au panier</a>
                    <br><br>
