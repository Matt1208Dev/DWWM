...
<?php //var_dump($categories); ?>
    ...
    <div class="row justify-content-center">
        ...
        <?php echo form_open(); ?>
            ...
            <div class="mt-3">
                <label class="form-label" for="pro_cat_id">Catégorie :</label>
                <select id="pro_cat_id" class="form-select" name="pro_cat_id" value="<?php echo set_value('pro_cat_id', $produit->pro_cat_id); ?>">
                    ...
                    {
                    ?>
                        <option value="<?php echo $row->cat_id ?>" <?php if (isset($_POST['pro_cat_id']) && $_POST['pro_cat_id'] == $row->cat_id || $produit->pro_cat_id == $row->cat_id) {echo "selected";} ?>> <?php echo $row->cat_nom ?> </option>
                    <?php
                    }
                    ?>
