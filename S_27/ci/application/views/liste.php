...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="table-responsive">
            ...
            // Boucle affichage lignes produit
            foreach ($liste as $row) 
            {   ?>
                    <tr style="border: 1px solid black; height:150px;">
                        <td class="align-middle bg-warning">
                            <img  alt="photo du produit <?= $row->pro_libelle; ?>" src="http://localhost/ci/assets/images/<?= $row->pro_id ?>.<?= $row->pro_photo ?>" width=140>
                        </td>
                        ...
                        <td class="table-active">
                            <a class="text-uppercase text-danger" href="<?php echo site_url("produits/details/$row->pro_id") ?>" title="Modifier"><strong><u><?= $row->pro_libelle; ?></u></strong></a>
                        </td>
                        <td class="table-active">
                            <?= $row->pro_prix; ?>
                        </td>
                        ...
                        <!-- champs invisible pour indiquer la quantité à commander -->
