            ...
            <div class="col">
                ...
                <section>
                    ...
                    <div class="text-center vh-100">
                        <p class="fs-2 mt-5">Oups ! La page ne peut être affichée. Nous travaillons à la résolution du problème.<br>Repassez un peu plus tard.</p>

                        <div>
                              <a class="btn btn-secondary btn-lg mt-3" role="button" href="#">Retour à l'accueil</a>
                         </div>
