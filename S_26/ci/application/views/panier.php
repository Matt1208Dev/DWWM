            ...
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <?php 
                        ...
                        // Boucle d'affichage de chasue ligne du panier
                        ...
                        {   
                            ...
                            <tr>
                                ...
                                <td class="col-xl-2 align-middle"> 
                                    ...
                                    <input class="form-control d-inline" style="width:30%;" type="number" name="pro_qte" id="pro_qte" value="<?php echo $row['pro_qte']; ?>" min="1">
                                    ...
                                    <!-- bouton Recalculer /  -->
                                    <button class="btn" type="submit" title="Recalculer"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="blue" class="table-warning bi bi-arrow-clockwise d-flex d-inline-block" viewBox="-5 -3 20 20">
